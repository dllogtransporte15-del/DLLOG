                ...
                <li key={index} className="flex flex-col text-sm border-b border-gray-100/70 dark:border-gray-700/50 last:border-b-0 pb-1.5 first:pt-0">
                  <div className="flex items-center justify-between gap-2 w-full">
                    <div className="flex items-center gap-1.5 min-w-0 flex-1 flex-wrap">
                      ...
                      <span className="text-gray-700 dark:text-gray-300 font-medium truncate" title={item.label}>
                        {item.label}:
                      </span>
                      {hasSubItems && (
                        <button
                          ...
                          className={`inline-flex items-center gap-1 px-2 py-0.5 text-[11px] font-bold rounded-md transition-all cursor-pointer shadow-2xs ${
                            isExpanded
                        ...
                        >
                          ...
                          <span>{isExpanded ? 'Recolher' : 'Exibir mais'}</span>
                          <ChevronDown className={`w-3 h-3 transition-transform duration-200 ${isExpanded ? 'rotate-180' : ''}`} />
                        </button>
                      )}
                    </div>
                    <span className="font-bold ml-auto text-gray-800 dark:text-gray-200 shrink-0">
                      ...
                      <div className="text-[10px] uppercase font-bold text-gray-500 dark:text-gray-400 mb-1.5 flex items-center justify-between pr-2">
                        ...
                        {item.clientId && onViewClientHistory && (
                          <button
                            ...
                            className="text-blue-600 dark:text-blue-400 hover:underline flex items-center gap-0.5 normal-case font-bold text-xs cursor-pointer"
                          >
